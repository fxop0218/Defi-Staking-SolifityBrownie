...
contract TokenFarm is Ownable {
    ...
    function issuesToken() public {
        ...
        for (
            ...
            address recipients = stakers[stakersIndex];
    ...
    function getUserTotalValue (address _user) view public returns (uint256) {
        ...
        for (uint256 tokenIndex = 0; tokenIndex < allowedTokens.length; tokenIndex++) {
            totalValue = totalValue + getUserSingleTokenValue(_user, allowedTokens[tokenIndex]);
        }
    }
    ...
    function getTokenValue(address _token) public view returns (uint256, uint256) {
        ...
        AggregatorV3Interface priceFeed = AggregatorV3Interface(preiceFeedAddress);
